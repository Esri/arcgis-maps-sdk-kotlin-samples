...
package com.esri.arcgismaps.sample.setmaxextent.screens
 ...
 */
@Composable
fun SetMaxExtentScreen(sampleName: String) {
    val mapViewModel: SetMaxExtentViewModel = viewModel()
            ...
            Column(
                ...
                MapView(
                    modifier = Modifier
                        .fillMaxSize()
                        .weight(1f),
                    arcGISMap = mapViewModel.coloradoMap,
