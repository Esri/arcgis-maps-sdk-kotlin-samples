...
class MainActivity : ComponentActivity() {
    ...
    @Composable
    private fun CreateSymbolStylesFromWebStylesApp() {
        Surface(color = MaterialTheme.colorScheme.background) {
            CreateSymbolStylesFromWebStylesScreen(
                sampleName = getString(R.string.create_symbol_styles_from_web_styles_app_name)
            )
        }
    }
}
