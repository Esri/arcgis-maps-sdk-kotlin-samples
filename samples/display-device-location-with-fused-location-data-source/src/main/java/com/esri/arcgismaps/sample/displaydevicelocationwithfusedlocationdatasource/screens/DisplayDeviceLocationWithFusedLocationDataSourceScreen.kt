...
fun DisplayDeviceLocationWithFusedLocationDataSourceScreen(sampleName: String) {
    ...
    val mapViewModel: DisplayDeviceLocationWithFusedLocationDataSourceViewModel = viewModel<DisplayDeviceLocationWithFusedLocationDataSourceViewModel>().apply {
        onSetLocationDisplay(locationDisplay)
    }
    Scaffold(
