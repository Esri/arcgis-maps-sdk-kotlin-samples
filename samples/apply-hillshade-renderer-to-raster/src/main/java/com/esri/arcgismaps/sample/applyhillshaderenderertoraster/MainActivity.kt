...
class MainActivity : ComponentActivity() {
    ...
    @Composable
    private fun ApplyHillshadeRendererToRasterApp() {
        Surface(color = MaterialTheme.colorScheme.background) {
            ApplyHillshadeRendererToRasterScreen(
                sampleName = getString(R.string.apply_hillshade_renderer_to_raster_app_name)
            )
        }
    }
}
