...
class MainActivity : ComponentActivity() {
    ...
    @Composable
    private fun ApplyColormapRendererToRasterApp() {
        Surface(color = MaterialTheme.colorScheme.background) {
            ApplyColormapRendererToRasterScreen(
                sampleName = getString(R.string.apply_colormap_renderer_to_raster_app_name)
            )
        }
    }
}
