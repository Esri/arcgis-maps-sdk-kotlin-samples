...
class MainActivity : ComponentActivity() {
    ...
    @Composable
    private fun ApplyBlendRendererToHillshadeApp() {
        Surface(color = MaterialTheme.colorScheme.background) {
            ApplyBlendRendererToHillshadeScreen(
                sampleName = getString(R.string.apply_blend_renderer_to_hillshade_app_name)
            )
        }
    }
}
