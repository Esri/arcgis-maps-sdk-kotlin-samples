...
![update-labels-and-symbols-to-scale-for-visual-accessibility.png](update-labels-and-symbols-to-scale-for-visual-accessibility.png)
...
Change the text size in the operating system's accessibility settings to see the restaurant labels and symbols resize. Use Open system text-size settings on Windows or Android. On iOS, open Settings > Accessibility > Display & Text Size > Larger Text.
