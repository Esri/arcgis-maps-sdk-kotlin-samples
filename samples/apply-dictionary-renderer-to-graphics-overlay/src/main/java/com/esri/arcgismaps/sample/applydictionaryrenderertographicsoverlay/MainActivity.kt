...
class MainActivity : ComponentActivity() {
    ...
    @Composable
    private fun ApplyDictionaryRendererToGraphicsOverlayApp() {
        Surface(color = MaterialTheme.colorScheme.background) {
            ApplyDictionaryRendererToGraphicsOverlayScreen(
                sampleName = getString(R.string.apply_dictionary_renderer_to_graphics_overlay_app_name)
            )
        }
    }
}
