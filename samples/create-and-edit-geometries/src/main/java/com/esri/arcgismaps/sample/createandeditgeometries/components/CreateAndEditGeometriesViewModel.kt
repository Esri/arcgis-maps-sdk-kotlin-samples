...
class CreateAndEditGeometriesViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val houseCoordinatesJson = """{"x": -1067898.59, "y": 6998366.62,
    "spatialReference": {"latestWkid":3857, "wkid":102100}}"""

    val outbuildingCoordinatesJson = """{"points":[[-1067984.26,6998346.28],[-1067966.80,6998244.84],
    ...
    val road1CoordinatesJson = """{"paths":[[[-1068095.40,6998123.52],[-1068086.16,6998134.60],
    ...
    val road2CoordinatesJson = """{"paths":[[[-1067999.28,6998061.97],[-1067994.48,6998086.59],
    ...
    val boundaryCoordinatesJson = """{ "rings": [[[-1067943.67,6998403.86],[-1067938.17,6998427.60],
        ...
        viewModelScope.launch {
            ...
            arcGISMap.load().onFailure { error ->
                ...
                graphicsOverlay.graphics.add(
                    Graphic(
                        geometry = Geometry.fromJsonOrNull(houseCoordinatesJson) as Point,
                        symbol = geometryEditorStyle.vertexSymbol
                    )
                )
                graphicsOverlay.graphics.add(
                    Graphic(
                        geometry = Geometry.fromJsonOrNull(outbuildingCoordinatesJson),
                        symbol = geometryEditorStyle.midVertexSymbol
                    )
                )
                graphicsOverlay.graphics.add(
                    Graphic(
                        geometry = Geometry.fromJsonOrNull(road1CoordinatesJson),
                        symbol = geometryEditorStyle.lineSymbol
                    )
                )
                graphicsOverlay.graphics.add(
                    Graphic(
                ...
                graphicsOverlay.graphics.add(
                    Graphic(
                        ...
                        symbol = geometryEditorStyle.fillSymbol
                    )
                )
            }
        }
